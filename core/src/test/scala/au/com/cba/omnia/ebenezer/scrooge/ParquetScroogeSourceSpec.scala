...
object ParquetScroogeSourceWithSuccessSpec extends ParquetScroogeReadWriteSpec {
  val specTitle = "ParquetScroogeSource used as a flat sink with _SUCCESS"
  def customerSink = ParquetScroogeSource[Customer]("customers")
  def additionalWriteFact = "customers" </> "_SUCCESS"   ==> exists

}

object ParquetScroogeSourceWithoutSuccessSpec extends ParquetScroogeReadWriteSpec {
  val specTitle = "UnpartitionedParquetScroogeSink used as a flat sink without _SUCCESS"
  def customerSink = UnpartitionedParquetScroogeSink[Customer]("customers")
  def additionalWriteFact = "customers" </> "_SUCCESS"   ==> missing
}

trait ParquetScroogeReadWriteSpec extends ThermometerSpec with ParquetLogging {
  def specTitle: String
  def customerSink: TypedSink[Customer]
  def additionalWriteFact: Fact
